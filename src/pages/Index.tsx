...
import { Star, Phone, Mail, ArrowRight, Play } from "lucide-react";
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            ...
            >
              ...
              <Link to="/products">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-green-800 text-lg px-8 py-4">
      ...
      <section className="py-16 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose Kemta Globals?</h2>
      ...
      {/* Products Preview with Scroll Animations */}
